...
function Login() {
    /* Allows session persistence, recall login */
    const history = useHistory();
    /*  email is empty str and setEmail is like 
        fcn setEmail(email) , 
        but email init to empty str */
    ...
    const login = (event) => {
        ...
        .then((auth) => {
        // logged in successfuly, redirect homepage
            history.push('/');
        })
